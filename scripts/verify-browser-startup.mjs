...
async function inspectMode(port,baseUrl,mode){
  ...
  console.log(`${mode}: post-start OK (${started.phase}; causal=${started.causal}; tutor=${started.tutor}; tutorUiDeferred=${started.tutorUiDeferred})`);
  ws.close();
}
